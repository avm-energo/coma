...
start /wait MSBuild "%cd%\xz-utilz\windows\vs2017\liblzma_dll.vcxproj" /property:Configuration=Release;Platform=x64;OutDir=..\..\..\..\libs\win64\release
start /wait MSBuild "%cd%\hidapi\windows\hidapi.vcxproj" /property:Configuration=Release;Platform=x64;OutDir=..\..\..\libs\win64\release
