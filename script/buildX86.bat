...
call MSBuild "%cd%\xz-utilz\windows\vs2017\liblzma_dll.vcxproj" /property:Configuration=Release;Platform=win32;OutDir=..\..\..\..\libs\win32\release
call MSBuild "%cd%\hidapi\windows\hidapi.vcxproj" /property:Configuration=Release;Platform=win32;OutDir=..\..\..\libs\win32\release
