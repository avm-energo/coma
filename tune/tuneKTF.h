#ifndef TuneDialogKTF_H
#define TuneDialogKTF_H
...
class TuneDialogKTF : public EAbstractTuneDialog
{
    Q_OBJECT
public:
    explicit TuneDialogKTF(QVector<S2::DataRec> *S2Config, QWidget *parent = nullptr);
    //~TuneDialog85();
    int inc;
    float samples[6];
