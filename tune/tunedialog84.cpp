...
void TuneDialog84::SetupUI()
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        le = new QLineEdit("");
        le->setObjectName("tune"+QString::number(i+39));
        le->setStyleSheet(ValuesLEFormat);
...
int TuneDialog84::TunePt100Channel()
{
    ...
    {
        if (TuneChannel() == Error::ER_NOERROR)
        {
          FillBac(0);
          return Error::ER_NOERROR;
        }
