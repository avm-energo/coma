...
//        glyout->addWidget(WDFunc::NewLE(m_BacWidget, "tune" + QString::number(i + 6), "", ValuesLEFormat), 3, i, 1,
//        1); glyout->addWidget(WDFunc::NewLBL(m_BacWidget, "KmI2[" + QString::number(i) + "]"), 2, i + 3, 1, 1);
//        glyout->addWidget(
...
//        glyout->addWidget(WDFunc::NewLE(m_BacWidget, "tune" + QString::number(i + 12), "", ValuesLEFormat), 5, i, 1,
//        1); glyout->addWidget(WDFunc::NewLBL(m_BacWidget, "KmI8[" + QString::number(i) + "]"), 4, i + 3, 1, 1);
//        glyout->addWidget(
...
//        glyout->addWidget(WDFunc::NewLE(m_BacWidget, "tune" + QString::number(i + 18), "", ValuesLEFormat), 7, i, 1,
//        1); glyout->addWidget(WDFunc::NewLBL(m_BacWidget, "KmI32[" + QString::number(i) + "]"), 6, i + 3, 1, 1);
//        glyout->addWidget(
...
//        glyout->addWidget(WDFunc::NewLE(m_BacWidget, "tune" + QString::number(i + 24), "", ValuesLEFormat), 9, i, 1,
//        1); glyout->addWidget(WDFunc::NewLBL(m_BacWidget, "TKPsi_b[" + QString::number(i) + "]"), 8, i + 3, 1, 1);
//        glyout->addWidget(
