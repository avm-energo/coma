...
QWidget *TuneKIV::BacWidget()
{
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        m_VModel->setData(m_VModel->index(4, i * 2 + 7), DataDelegate::DataFormat::OUTVALUEINT);
...
QWidget *TuneKIV::BdaWidget()
{
    ...
    m_VModel->setData(m_VModel->index(1, 1), DataDelegate::DataFormat::OUTVALUEINT);
    m_VModel->setValueData(m_VModel->index(1, 1), &m_Bda.Frequency);
    m_VModel->setData(m_VModel->index(1, 2), "Pt100");
    m_VModel->setData(m_VModel->index(1, 3), DataDelegate::DataFormat::OUTVALUEINT);
