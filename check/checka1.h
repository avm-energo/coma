...
public:
    ...
    struct A1_Bd1
    {
        ...
        float dUrms;            // относительная погрешность в %
        float Uef_filt[2];		// Действующие значения первых гармоник напряжений (в вольтах  на входе прибора)
        float dU;               // относительная погрешность по 1-й гармонике в %
        float Phy;              // разность фаз первых гармоник напряжений в срад
    ...
    struct A1_Bd2
    {
        float HarmBuf[2][62]; // 1-й индекс – номер канала, 2-й – номер гармоники (в 0-й ячейке – 2-я гармоника, в 60-й – 62я)
    };
