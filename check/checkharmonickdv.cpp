...
CheckHarmonicKDV::CheckHarmonicKDV()
{
...
QWidget *CheckHarmonicKDV::Bd7W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd8W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd9W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd10W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd11W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd12W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd13W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd14W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd15W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd16W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
QWidget *CheckHarmonicKDV::Bd17W(QWidget *parent)
{
    int i;
    QWidget *w = new QWidget(parent);
    QVBoxLayout *lyout = new QVBoxLayout;
...
void CheckHarmonicKDV::FillBd7(QWidget *parent)
{
    for (int j = 0; j < 3; j++)
    {
        for (int i = 0; i < 61; i++)
