...
QWidget *CheckKTF::Bd1W(QWidget *parent)
{
    ...
    for (i = 0; i < 4; ++i)
    {
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(2424 + i), ValuesFormat,
                              "Реактивная мощность по кажущейся полной и истинной активной, кВАр"),
            9, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1220 + i), ValuesFormat,
                              "Истинные действующие значения линейных напряжений трех фази их среднее, кВ"),
            15, i, 1, 1);
    }
...
QWidget *CheckKTF::Bd2W(QWidget *parent)
{
    ...
    glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(4010), ValuesFormat,
                          "Оставшееся время работы до предупрежде-ния при данной нагрузке, сек"),
        1, 0, 1, 1);
...
QWidget *CheckKTF::Bd4W(QWidget *parent)
{
    ...
    for (i = 0; i < 4; ++i)
    {
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1004 + i), ValuesFormat,
                              "Действующие значения сигналов трех фаз по 1-й гармонике и их среднее, кВ"),
            1, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1404 + i), ValuesFormat,
                              "Действующие значения сигналов трех фаз по 1-й гармонике и их среднее, А"),
            3, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1224 + i), ValuesFormat,
                              "Действующие значения 1-й гармоники линейных напряжений трех фази их среднее, кВ"),
            13, i, 1, 1);
    }
...
QWidget *CheckKTF::Bd5W(QWidget *parent)
{
    ...
    glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1023), ValuesFormat,
                          "Коэффициент несимметрии напряжения по обратной последовательности гр.1, %"),
        3, 0, 1, 1);
    ...
    glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1024), ValuesFormat,
                          "Коэффициент несимметрии напряжения по нулевой последовательности гр.1, %"),
        3, 1, 1, 1);
    for (i = 0; i < 3; ++i)
    {
...
void CheckKTF::FillBd2(QWidget *parent)
{
    ...
    // WDFunc::SetLBLText(parent, QString::number(1028+i+61*j), WDFunc::StringValueWithCheck(Bd_block2.UI_Harm[j][i],
    // 3));
...
void CheckKTF::FillBd3(QWidget *parent)
{
    ...
    for (int j = 0; j < 3; j++)
    {
      ...
      WDFunc::SetLBLText(parent, QString::number(1428+i+61*j), WDFunc::StringValueWithCheck(Bd_block3.UI_Harm[j][i],
    3));
