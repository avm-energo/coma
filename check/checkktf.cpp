...
QWidget *CheckKTF::Bd6W(QWidget *parent)
{
    ...
    for (i = 0; i < 3; ++i)
    {
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1028 + i * 61), ValuesFormat,
                              "2-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            1, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1029 + i * 61), ValuesFormat,
                              "3-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            3, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1030 + i * 61), ValuesFormat,
                              "4-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            5, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1031 + i * 61), ValuesFormat,
                              "5-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            7, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1032 + i * 61), ValuesFormat,
                              "6-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            9, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1033 + i * 61), ValuesFormat,
                              "7-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            11, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1034 + i * 61), ValuesFormat,
                              "8-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            13, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1035 + i * 61), ValuesFormat,
                              "9-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            15, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1036 + i * 61), ValuesFormat,
                              "10-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            17, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1037 + i * 61), ValuesFormat,
                              "11-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            19, i, 1, 1);
    }
...
QWidget *CheckKTF::Bd7W(QWidget *parent)
{
    ...
    for (i = 0; i < 3; ++i)
    {
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1038 + i * 61), ValuesFormat,
                              "12-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            1, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1039 + i * 61), ValuesFormat,
                              "13-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            3, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1040 + i * 61), ValuesFormat,
                              "14-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            5, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1041 + i * 61), ValuesFormat,
                              "15-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            7, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1042 + i * 61), ValuesFormat,
                              "16-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            9, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1043 + i * 61), ValuesFormat,
                              "17-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            11, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1044 + i * 61), ValuesFormat,
                              "18-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            13, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1045 + i * 61), ValuesFormat,
                              "19-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            15, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1046 + i * 61), ValuesFormat,
                              "20-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            17, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1047 + i * 61), ValuesFormat,
                              "21-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            19, i, 1, 1);
    }
...
QWidget *CheckKTF::Bd8W(QWidget *parent)
{
    ...
    for (i = 0; i < 3; ++i)
    {
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1048 + i * 61), ValuesFormat,
                              "22-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            1, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1049 + i * 61), ValuesFormat,
                              "23-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            3, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1050 + i * 61), ValuesFormat,
                              "24-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            5, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1051 + i * 61), ValuesFormat,
                              "25-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            7, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1052 + i * 61), ValuesFormat,
                              "26-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            9, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1053 + i * 61), ValuesFormat,
                              "27-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            11, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1054 + i * 61), ValuesFormat,
                              "28-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            13, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1055 + i * 61), ValuesFormat,
                              "29-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            15, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1056 + i * 61), ValuesFormat,
                              "30-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            17, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1057 + i * 61), ValuesFormat,
                              "31-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            19, i, 1, 1);
    }
...
QWidget *CheckKTF::Bd9W(QWidget *parent)
{
    ...
    for (i = 0; i < 3; ++i)
    {
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1058 + i * 61), ValuesFormat,
                              "32-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            1, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1059 + i * 61), ValuesFormat,
                              "33-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            3, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1060 + i * 61), ValuesFormat,
                              "34-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            5, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1061 + i * 61), ValuesFormat,
                              "35-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            7, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1062 + i * 61), ValuesFormat,
                              "36-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            9, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1063 + i * 61), ValuesFormat,
                              "37-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            11, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1064 + i * 61), ValuesFormat,
                              "38-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            13, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1065 + i * 61), ValuesFormat,
                              "39-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            15, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1066 + i * 61), ValuesFormat,
                              "40-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            17, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1067 + i * 61), ValuesFormat,
                              "41-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            19, i, 1, 1);
    }
...
QWidget *CheckKTF::Bd10W(QWidget *parent)
{
    ...
    for (i = 0; i < 3; ++i)
    {
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1068 + i * 61), ValuesFormat,
                              "42-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            1, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1069 + i * 61), ValuesFormat,
                              "43-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            3, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1070 + i * 61), ValuesFormat,
                              "44-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            5, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1071 + i * 61), ValuesFormat,
                              "45-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            7, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1072 + i * 61), ValuesFormat,
                              "46-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            9, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1073 + i * 61), ValuesFormat,
                              "47-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            11, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1074 + i * 61), ValuesFormat,
                              "48-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            13, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1075 + i * 61), ValuesFormat,
                              "49-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            15, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1076 + i * 61), ValuesFormat,
                              "50-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            17, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1077 + i * 61), ValuesFormat,
                              "51-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            19, i, 1, 1);
    }
...
QWidget *CheckKTF::Bd11W(QWidget *parent)
{
    ...
    for (i = 0; i < 3; ++i)
    {
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1078 + i * 61), ValuesFormat,
                              "52-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            1, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1079 + i * 61), ValuesFormat,
                              "53-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            3, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1080 + i * 61), ValuesFormat,
                              "54-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            5, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1081 + i * 61), ValuesFormat,
                              "55-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            7, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1082 + i * 61), ValuesFormat,
                              "56-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            9, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1083 + i * 61), ValuesFormat,
                              "57-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            11, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1084 + i * 61), ValuesFormat,
                              "58-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            13, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1085 + i * 61), ValuesFormat,
                              "59-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            15, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1086 + i * 61), ValuesFormat,
                              "60-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            17, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1087 + i * 61), ValuesFormat,
                              "61-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            19, i, 1, 1);
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1088 + i * 61), ValuesFormat,
                              "62-я гармоника напряжения в фазе" + phase[i] + "в % от 1-й", true),
            21, i, 1, 1);
    }
...
QWidget *CheckKTF::Bd17W(QWidget *parent)
{
    ...
    for (i = 0; i < 3; ++i)
    {
        ...
        glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1488 + i * 61), ValuesFormat,
                              "62-я гармоника тока в фазе" + phase[i] + "в % от 1-й", true),
            19, i, 1, 1);
    }
...
{
    // WDFunc::SetLBLText(parent, "value0",
    // WDFunc::StringValueWithCheck(Bd_block1.NUM, 3));
    WDFunc::SetLBLText(parent, QString::number(4500), WDFunc::StringValueWithCheck(Bd_block13.TempWinding, 3));
    //   WDFunc::SetLBLText(parent,  QString::number(4500),
    //   WDFunc::StringValueWithCheck(Bd_block13.ExtTempWin[0], 3));
...
void CheckKTF::FillBd2(QWidget *parent)
{
    ...
    /*
        WDFunc::SetLBLText(parent, QString::number(1020),
    WDFunc::StringValueWithCheck(Bd_block2.U0, 3)); WDFunc::SetLBLText(parent,
    QString::number(1021), WDFunc::StringValueWithCheck(Bd_block2.U1, 3));
          WDFunc::SetLBLText(parent, QString::number(1022),
    WDFunc::StringValueWithCheck(Bd_block2.U2, 3)); WDFunc::SetLBLText(parent,
    QString::number(1023), WDFunc::StringValueWithCheck(Bd_block2.Kunsim0, 3));
            WDFunc::SetLBLText(parent, QString::number(1024),
    WDFunc::StringValueWithCheck(Bd_block2.Kunsim2, 3));


     for (int i = 0; i < 4; i++)
         {
            WDFunc::SetLBLText(parent, QString::number(1025+i),
    WDFunc::StringValueWithCheck(Bd_block2.THD[i], 3));
        // WDFunc::SetLBLText(parent, QString::number(1025+i),
    WDFunc::StringValueWithCheck(QQQ, 3));
    ...
    // WDFunc::StringValueWithCheck(Bd_block2.UI_Harm[j][i], 3));
    //  WDFunc::SetLBLText(parent, QString::number(1028+i+61*j),
    //  WDFunc::StringValueWithCheck(QQQ, 3));
...
void CheckKTF::FillBd3(QWidget *parent)
{
    ...
    /*
      WDFunc::SetLBLText(parent, QString::number(1420),
    WDFunc::StringValueWithCheck(Bd_block2.U0, 3)); WDFunc::SetLBLText(parent,
    QString::number(1421), WDFunc::StringValueWithCheck(Bd_block2.U1, 3));
        WDFunc::SetLBLText(parent, QString::number(1422),
    WDFunc::StringValueWithCheck(Bd_block2.U2, 3)); WDFunc::SetLBLText(parent,
    QString::number(1423), WDFunc::StringValueWithCheck(Bd_block2.Kunsim0, 3));
          WDFunc::SetLBLText(parent, QString::number(1424),
    WDFunc::StringValueWithCheck(Bd_block2.Kunsim2, 3));


    for (int i = 0; i < 4; i++)
       {
          WDFunc::SetLBLText(parent, QString::number(1425+i),
    WDFunc::StringValueWithCheck(Bd_block2.THD[i], 3));
    ...
    WDFunc::StringValueWithCheck(Bd_block3.UI_Harm[j][i], 3));
...
void CheckKTF::FillBd5(QWidget *parent)
{
    for (int j = 0; j < 3; j++)
    {
        for (int i = 0; i < 61; i++)
...
void CheckKTF::FillBd7(QWidget *parent)
{
    for (int j = 0; j < 3; j++)
    {
        for (int i = 0; i < 61; i++)
