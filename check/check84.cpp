...
QWidget *Check_84::Bd2W(QWidget *parent)
{
    ...
    glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1023), ValuesFormat, \
                                      QString::number(32)+".Коэффициент несимметрии по нулевой последовательности по
    напряжению"),3,0,1,1); glyout->addWidget(WDFunc::NewLBL(parent, "Kunsim2"),2,1,1,1);
    glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1024), ValuesFormat, \
                                      QString::number(33)+".Коэффициент несимметрии по обратной последовательности по
    напряжению"),3,1,1,1);*/
    ...
    /* glyout->addWidget(WDFunc::NewLBL(parent, "Kunsim0"),6,0,1,1);
     glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1123), ValuesFormat, \
                                       QString::number(37)+".Коэффициент несимметрии по нулевой последовательности по
     току"),7,0,1,1); glyout->addWidget(WDFunc::NewLBL(parent, "Kunsim2"),6,1,1,1);
     glyout->addWidget(WDFunc::NewLBLT(parent, "", QString::number(1124), ValuesFormat, \
                                       QString::number(38)+".Коэффициент несимметрии по обратной последовательности по
     току"),7,1,1,1); glyout->addWidget(WDFunc::NewLBL(parent, "KrF ф.A"),8,0,1,1);
