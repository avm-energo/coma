...
void CheckDialogKIV::UpdateModBusData(QList<ModBus::SignalStruct> Signal)
{
    ...
    for(i=0; i<Signal.size(); ++i)
    {
      ...
      ChKIV->FillBd(this, QString::number((Signal.at(i).SigAdr)+9), WDFunc::StringValueWithCheck(Signal.at(i).flVal, 3));
      else
      ChKIV->FillBd(this, QString::number(Signal.at(i).SigAdr), WDFunc::StringValueWithCheck(Signal.at(i).flVal, 3));
    }
}
