...
//        glyout->addWidget(
//            WDFunc::NewLBLT(parent, "", QString::number(2423 + i), ValuesFormat, "Тангенсы дельта вводов, %"), 9, i,
//            1, 1);
...
//    glyout->addWidget(
//        WDFunc::NewLBLT(parent, "", QString::number(2432), ValuesFormat, "Действующее значение тока небаланса, %"),
//        15, 0, 1, 1);
...
//    glyout->addWidget(
//        WDFunc::NewLBLT(parent, "", QString::number(1021), ValuesFormat, "Напряжение прямой последовательности, кВ"),
//        1, 1, 1, 1);
//    glyout->addWidget(WDFunc::NewLBL(parent, "U2, кВ"), 0, 2, 1, 1);
//    glyout->addWidget(
//        WDFunc::NewLBLT(parent, "", QString::number(1022), ValuesFormat, "Напряжение обратной последовательности,
//        кВ"), 1, 2, 1, 1);
//    glyout->addWidget(WDFunc::NewLBL(parent, "I0, мА"), 2, 0, 1, 1);
//    glyout->addWidget(
//        WDFunc::NewLBLT(parent, "", QString::number(1120), ValuesFormat, "Ток нулевой последовательности, мА"), 3, 0,
//        1, 1);
//    glyout->addWidget(WDFunc::NewLBL(parent, "I1, мА"), 2, 1, 1, 1);
//    glyout->addWidget(
//        WDFunc::NewLBLT(parent, "", QString::number(1121), ValuesFormat, "Ток прямой последовательности, мА"), 3, 1,
//        1, 1);
