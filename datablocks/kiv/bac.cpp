...
QWidget *Bac::widget()
{
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i), "", ValuesLEFormat), 1, i, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "KmU[" + QString::number(i) + "]"), 0, i + 3, 1, 1);
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i + 3), "", ValuesLEFormat), 1, i + 3, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "KmI1[" + QString::number(i) + "]"), 2, i, 1, 1);
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i + 6), "", ValuesLEFormat), 3, i, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "KmI2[" + QString::number(i) + "]"), 2, i + 3, 1, 1);
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i + 9), "", ValuesLEFormat), 3, i + 3, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "KmI4[" + QString::number(i) + "]"), 4, i, 1, 1);
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i + 12), "", ValuesLEFormat), 5, i, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "KmI8[" + QString::number(i) + "]"), 4, i + 3, 1, 1);
        glyout->addWidget(
            WDFunc::NewLE(m_widget, "tune" + QString::number(i + 15), "", ValuesLEFormat), 5, i + 3, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "KmI16[" + QString::number(i) + "]"), 6, i, 1, 1);
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i + 18), "", ValuesLEFormat), 7, i, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "KmI32[" + QString::number(i) + "]"), 6, i + 3, 1, 1);
        glyout->addWidget(
            WDFunc::NewLE(m_widget, "tune" + QString::number(i + 21), "", ValuesLEFormat), 7, i + 3, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "TKPsi_a[" + QString::number(i) + "]"), 8, i, 1, 1);
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i + 24), "", ValuesLEFormat), 9, i, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "TKPsi_b[" + QString::number(i) + "]"), 8, i + 3, 1, 1);
        glyout->addWidget(
            WDFunc::NewLE(m_widget, "tune" + QString::number(i + 27), "", ValuesLEFormat), 9, i + 3, 1, 1);
    }
    for (int i = 0; i < 6; i++)
    {
        glyout->addWidget(WDFunc::NewLBL(m_widget, "DPsi[" + QString::number(i) + "]"), 10, i, 1, 1);
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i + 30), "", ValuesLEFormat), 11, i, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "TKUa[" + QString::number(i) + "]"), 12, i, 1, 1);
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i + 36), "", ValuesLEFormat), 13, i, 1, 1);
        glyout->addWidget(WDFunc::NewLBL(m_widget, "TKUb[" + QString::number(i) + "]"), 14, i, 1, 1);
        glyout->addWidget(WDFunc::NewLE(m_widget, "tune" + QString::number(i + 42), "", ValuesLEFormat), 15, i, 1, 1);
    }

    glyout->addWidget(WDFunc::NewLBL(m_widget, "K_freq"), 16, 0, 1, 1);
    glyout->addWidget(WDFunc::NewLE(m_widget, "tune48", "", ValuesLEFormat), 17, 0, 1, 1);
    glyout->addWidget(WDFunc::NewLBL(m_widget, "Art"), 16, 1, 1, 1);
    glyout->addWidget(WDFunc::NewLE(m_widget, "tune49", "", ValuesLEFormat), 17, 1, 1, 1);
    glyout->addWidget(WDFunc::NewLBL(m_widget, "Brt"), 16, 2, 1, 1);
    glyout->addWidget(WDFunc::NewLE(m_widget, "tune50", "", ValuesLEFormat), 17, 2, 1, 1);
    glyout->addWidget(WDFunc::NewLBL(m_widget, "Tmk0"), 16, 3, 1, 1);
    glyout->addWidget(WDFunc::NewLE(m_widget, "tune51", "", ValuesLEFormat), 17, 3, 1, 1);
    gb->setLayout(vlyout);
    lyout->addWidget(gb);
...
void Bac::updateWidget()
{
    for (int i = 0; i < 3; i++)
    {
        ...
        WDFunc::SetLEData(m_widget, "tune" + QString::number(i + 12), QString::number(m_blockData->KmI4[i], 'f', 5));
        WDFunc::SetLEData(m_widget, "tune" + QString::number(i + 15), QString::number(m_blockData->KmI8[i], 'f', 5));
        WDFunc::SetLEData(m_widget, "tune" + QString::number(i + 18), QString::number(m_blockData->KmI16[i], 'f', 5));
        WDFunc::SetLEData(m_widget, "tune" + QString::number(i + 21), QString::number(m_blockData->KmI32[i], 'f', 5));
        WDFunc::SetLEData(m_widget, "tune" + QString::number(i + 24), QString::number(m_blockData->TKPsi_a[i], 'e', 5));
        WDFunc::SetLEData(m_widget, "tune" + QString::number(i + 27), QString::number(m_blockData->TKPsi_b[i], 'e', 5));
    }

    for (int i = 0; i < 6; i++)
    {
        WDFunc::SetLEData(m_widget, "tune" + QString::number(i + 30), QString::number(m_blockData->DPsi[i], 'f', 5));
        WDFunc::SetLEData(m_widget, "tune" + QString::number(i + 36), QString::number(m_blockData->TKUa[i], 'e', 5));
        WDFunc::SetLEData(m_widget, "tune" + QString::number(i + 42), QString::number(m_blockData->TKUb[i], 'e', 5));
    }
...
void Bac::updateFromWidget()
{
    ...
    for (int i = 0; i < 6; i++)
    {
        WDFunc::LEData(m_widget, "tune" + QString::number(i + 30));
        m_blockData->DPsi[i] = StdFunc::toFloat(tmps);
        WDFunc::LEData(m_widget, "tune" + QString::number(i + 36));
        m_blockData->TKUa[i] = StdFunc::toFloat(tmps);
        WDFunc::LEData(m_widget, "tune" + QString::number(i + 42));
        m_blockData->TKUb[i] = StdFunc::toFloat(tmps);
    }

    WDFunc::LEData(m_widget, "tune48");
    m_blockData->K_freq = StdFunc::toFloat(tmps);
    WDFunc::LEData(m_widget, "tune49");
    m_blockData->Art = StdFunc::toFloat(tmps);
    WDFunc::LEData(m_widget, "tune50");
    m_blockData->Brt = StdFunc::toFloat(tmps);
    WDFunc::LEData(m_widget, "tune51");
    m_blockData->Tmk0 = StdFunc::toFloat(tmps);
}
