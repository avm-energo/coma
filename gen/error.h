...
#define S2_DESCERROR                                                                                                   \
    9 // несовпадение описания прочитанного элемента с ожидаемым при работе с
      // форматом S2
...
#define CN_RCVDATAERROR                                                                                                \
    74 // ошибка при приёме данных (несовпадение длины, неправильный начальный
       // символ и т.п.)
#define CN_TIMEOUTERROR 75 // таймаут при приёме данных
#define CN_RCVLENGTHERROR                                                                                              \
    76 // некорректная длина блока (принято больше, чем может вместить в себя
       // приёмная переменная)
