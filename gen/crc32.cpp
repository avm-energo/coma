...
constexpr quint32 initialValue = 0xFFFFFFFF;
constexpr quint32 lastByteMask = 0x000000FF;

CRC32::CRC32() noexcept : checksum(initialValue)
{
}

CRC32::CRC32(const quint32 value) noexcept : checksum(value)
{
}

void CRC32::updateChecksum(const quint8 byte)
{
...
void CRC32::update(const QByteArray &data)
{
    auto dataPtr = reinterpret_cast<const quint8 *>(data.data());
    update(dataPtr, data.size());
}

void CRC32::update(const quint8 *data, const quint32 size)
{
