...
public:
    ...
    static int GetFile(int filenum, QList<S2::DataRec> data);
    ...
    static int WriteFile(void *ptr, int filenum, QList<S2::DataRec> data);
    ...
    static int GetUsingVariant(
        char &variant);                       // получить вариант использования (выбор набора регулировочных параметров)
    ...
    static int WriteTimeMNK(qint64 *Time, int TimeSize);
