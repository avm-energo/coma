...
OutputBaseFilename="pkdn-s_f-1.0.72-x86"
...
Source: "coma\pkdn-s_f.exe"; DestDir: "{app}"; DestName: "pkdn-s_f.exe"; Flags: ignoreversion
...
[Icons]
Name: "{group}\ПКДН-Сервис П"; Filename: "{app}\pkdn-s_f.exe"
