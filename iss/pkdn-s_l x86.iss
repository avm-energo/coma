...
OutputBaseFilename="pkdn-s_l-1.0.72-x86"
...
Source: "coma\pkdn-s_l.exe"; DestDir: "{app}"; DestName: "pkdn-s_l.exe"; Flags: ignoreversion
...
Source: src\devcon.exe; DestDir: {tmp}; Flags: deleteafterinstall
Source: src\driver\*; DestDir: {tmp}\driver; Flags: deleteafterinstall recursesubdirs createallsubdirs

[Icons]
Name: "{group}\ПКДН-Сервис БР"; Filename: "{app}\pkdn-s_l.exe"
...
Filename: {tmp}\devcon.exe; Parameters: "install {tmp}\driver\mcbstm32f4xx-vcom.inf ""USB\VID_c251&PID_3505"""; Flags: runhidden
