...
#define SetupName "avtuks-F-2.2.260-x64"
...
Source: "{#Prefix}\qt5.11.1-x64\*.dll"; DestDir: "{app}"
Source: "{#Prefix}\qt5.11.1-x64\platforms\qwindows.dll"; DestDir: "{app}\platforms"
...
Source: "{#Prefix}\common\vc2017\vc_redist.x64.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
