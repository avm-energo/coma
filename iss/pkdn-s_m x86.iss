...
OutputBaseFilename="pkdn-s_m-1.0.72-x86"
...
Source: "coma\pkdn-s_m.exe"; DestDir: "{app}"; DestName: "pkdn-s_m.exe"; Flags: ignoreversion
...
[Icons]
Name: "{group}\ПКДН-Сервис CР"; Filename: "{app}\pkdn-s_m.exe"
