...
Config84::Config84(QVector<S2::DataRec> &config)
{
    ...
    if ((StartInIndex != 0))
    {
        ...
        config.append({StartInIndex+6, sizeof(Bci_block.dС_pred), &Bci_block.dС_pred});
        config.append({StartInIndex+7, sizeof(Bci_block.dС_alarm), &Bci_block.dС_alarm});
        ...
        config.append({StartInIndex+12, sizeof(Bci_block.GdС), &Bci_block.GdС});
