...
void ConfDialogKTF::SetupUI()
{
    ...
    glyout->addWidget(
        WDFunc::NewLBL(this, "Максимальное измеряемый ток на входе прибора, А эфф (не более 33А) :"), row, 1, 1, 1);
    ...
    glyout->addWidget(
        WDFunc::NewLBL(this, "Уставка скачка напряжения для запуска осциллографирования - % от номинала:"), row, 0, 1,
        1);
