...
//        float RESkz[3]; 	// Начальное значение электрического износа для каждого полюса
        ...
        float Tdis_OFF;  //дополнительное смещение момента отключения во избежании повторного зажигания, мс
        float Tdis_ON; //дополнительное смещение момента включения для снижения перенапряжений, мс
