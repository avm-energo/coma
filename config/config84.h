...
public:
    ...
    typedef struct
    {
        ...
        float dС_pred;	// уставка предупредительной сигнализации
                    // по изменению емкости
        float dС_alarm;	// уставка аварийной сигнализации
                    // по изменению емкости
        ...
        float dIunb_alarm;   	// уставка аварийной сигнализации
                        // по изменению небаланса токов
        float GdС;		// гистерезис на отключение сигнализации по dC, % от уставки
