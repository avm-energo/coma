...
{
public:
    explicit Config80(QVector<S2::DataRec> &config);
    ...
    typedef struct
    {
        ...
        float Unom_1;           // Номинальное вторичное напряжение первой тройки
        float Unom_2;           // Номинальное вторичное напряжение второй тройки
    } Bci;
