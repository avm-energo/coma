...
void ConfDialog84::SetupUI()
{
    ...
    row++;
    glyout->addWidget(
        WDFunc::NewLBL(this, "Уставка предупредительной сигнализации по изменению небаланса токов, %:"), row, 1, 1, 1);
    ...
    /*for (int i = 0; i < 4; i++)
    {
     glyout->addWidget(WDFunc::NewSPB(this, "IP"+QString::number(i), 0, 10000, 0, paramcolor), row,1+i,1, 1,
    Qt::AlignLeft);
    }*/
    ...
    /*for (int i = 0; i < 4; i++)
    {
     glyout->addWidget(WDFunc::NewSPB(this, "Mask"+QString::number(i), 0, 10000, 0, paramcolor) , row,1+i,1,1,
    Qt::AlignLeft);
    }*/
    ...
    /*for (int i = 0; i < 4; i++)
    {
     glyout->addWidget(WDFunc::NewSPB(this, "GateWay"+QString::number(i), 0, 10000, 0, paramcolor), row,1+i,1,1,
    Qt::AlignLeft);
    }*/
    ...
    /*for (int i = 0; i < 4; i++)
    {
     glyout->addWidget(WDFunc::NewSPB(this, "Port"+QString::number(i), 0, 10000, 0, paramcolor), row,2+i,1,1,
    Qt::AlignLeft);
    }*/
    ...
    /*for (int i = 0; i < 4; i++)
    {
     glyout->addWidget(WDFunc::NewSPB(this, "SNTP"+QString::number(i), 0, 10000, 0, paramcolor), row,1+i,1,1,
    Qt::AlignLeft);
    }*/
