...
TuneKIVTemp60::TuneKIVTemp60(S2::Configuration &config, int tuneStep, QWidget *parent)
...
Error::Msg TuneKIVTemp60::setNewConfAndTune()
{
    ...
    auto status = BaseConnection::iface()->writeFileSync(S2::FilesEnum::Config, s2file);
