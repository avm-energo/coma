...
### MAIN PART
set(GEN_DIR ${CMAKE_SOURCE_DIR}/${PROJECT_TARGET_NAME})
set(GEN_BINARY_DIR ${GEN_DIR}/bin)
set(GEN_INCLUDE_DIRS ${GEN_DIR}/include)
set(GEN_LIBRARY_DIR ${GEN_DIR}/lib)
...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND
    ...
    -DGEN_BIN_DIR:PATH=${GEN_BINARY_DIR}
    -DGEN_LIB_DIR:PATH=${GEN_LIBRARY_DIR}
...
if(CMAKE_SYSTEM_NAME_LOWER STREQUAL "windows")
    ...
    install(FILES ${GEN_LIBRARY_DIR}/libgen.so DESTINATION ${CMAKE_BINARY_DIR}/bin)
endif()
