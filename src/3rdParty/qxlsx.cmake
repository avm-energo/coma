...
ExternalProject_Add(QXlsxBuild
    ...
    CONFIGURE_COMMAND ${CMAKE_COMMAND} -A${QXLSX_TARGET_NAME} -S ${QXLSX_SRC_DIR} -DQt${QT_VERSION_MAJOR}_DIR:STRING=${QT_DIR} -DCMAKE_BUILD_TYPE:String=Release -DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_SOURCE_DIR}/${PROJECT_TARGET_NAME}
