...
//    gridlyout->addWidget(WDFunc::NewLBL2(this, "Паспортные значения ёмкости вводов, пФ:"), row, 1, 1, 1,
//    Qt::AlignTop);
...
//    WDFunc::SetChBData(this, nameByValue(BciNumber::IsIuIunb),
//    bool(S2::getRecord(BciNumber::IsIuIunb).value<BYTE>()));
//}
