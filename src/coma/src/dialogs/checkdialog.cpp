...
const QMap<int, Qt::GlobalColor> c_activeColor
    = { { 0, Qt::cyan }, { 1, Qt::green }, { 2, Qt::yellow }, { 3, Qt::red } };
...
{
    m_curAdrIsYellow[reg] = true;
    if ((m_curHighlight[reg] == Highlights::YELLOW) || (m_curHighlight[reg] == Highlights::RED))
        return false;
