...
constexpr auto libavmgen = "avm-gen library, version 3.0.0 (https://git.avmenergo.ru/avm-energo/avm-gen.git)";
constexpr auto libavmwidgets
    = "AVM-Widgets library, version 3.0.0 (https://git.avmenergo.ru/avm-energo/avm-widgets.git)";
