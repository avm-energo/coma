...
void HiddenDialog::setupUI()
{
    ...
    hlyout = new QHBoxLayout;
    WDFunc::AddLabelAndLineeditH(this, hlyout, "Версия платы:", "mezhwmv", false);
    WDFunc::AddLabelAndLineeditH(this, hlyout, ".", "mezhwlv", false);
    WDFunc::AddLabelAndLineeditH(this, hlyout, ".", "mezhwsv", false);
    gblyout->addLayout(hlyout);
    hlyout = new QHBoxLayout;
    WDFunc::AddLabelAndLineeditH(this, hlyout, "Серийный номер платы:", "mezsn", false);
    gblyout->addLayout(hlyout);
    ...
    hlyout = new QHBoxLayout;
    WDFunc::AddLabelAndLineeditH(this, hlyout, "Тип платы:", "bastp", false);
    gblyout->addLayout(hlyout);
    hlyout = new QHBoxLayout;
    WDFunc::AddLabelAndLineeditH(this, hlyout, "Версия платы:", "bashwmv", false);
    WDFunc::AddLabelAndLineeditH(this, hlyout, ".", "bashwlv", false);
    WDFunc::AddLabelAndLineeditH(this, hlyout, ".", "bashwsv", false);
    gblyout->addLayout(hlyout);
    hlyout = new QHBoxLayout;
    WDFunc::AddLabelAndLineeditH(this, hlyout, "Серийный номер платы:", "bassn", false);
    gblyout->addLayout(hlyout);
    gb->setLayout(gblyout);
    hlyout = new QHBoxLayout;
    hlyout->addStretch(600);
