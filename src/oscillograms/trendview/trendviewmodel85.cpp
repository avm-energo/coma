...
{
    return { "Оперативное управление включением полюса А",                                            //
        ...
        "Выходная команда на отключение полюса С", "Включение полюса А нефильтр.", "Включение полюса В нефильтр.",
        "Включение полюса С нефильтр.", "Отключение полюса А нефильтр.", "Отключение полюса В нефильтр.",
        "Отключение полюса С нефильтр.",                                            //
        "НЗ блок-контакт полюса А нефильтр.", "НЗ блок-контакт полюса B нефильтр.", //
        "НЗ блок-контакт полюса C нефильтр.", "НО блок-контакт полюса А нефильтр.", //
        "НО блок-контакт полюса В нефильтр.", "НО блок-контакт полюса С нефильтр." };
}
