...
QVariant ErrorProtocolModel::data(const QModelIndex &index, int role) const
{
    if (index.isValid())
    {
        if (index.row() < erdata.size())
        {
            ...
            {
                if (ertypedata.at(index.row()) == Error::ER_MSG)
                    return QVariant::fromValue(QIcon(Settings::configDir() + "images/er_msg.png"));
                else if (ertypedata.at(index.row()) == Error::WARN_MSG)
                    return QVariant::fromValue(QIcon(Settings::configDir() + "images/warn_msg.png"));
                else if (ertypedata.at(index.row()) == Error::INFO_MSG)
                    return QVariant::fromValue(QIcon(Settings::configDir() + "images/info_msg.png"));
                else if (ertypedata.at(index.row()) == Error::DBG_MSG)
                    return QVariant::fromValue(QIcon(Settings::configDir() + "images/dbg_msg.png"));
                else
                    return QVariant();
            }
        }
