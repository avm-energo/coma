...
constexpr char department[] = "ООО \"АВМ-Энерго\", 2016-2023";
...
constexpr char qxlsx[] = "QXlsx library, version 1.4.4 (https://qtexcel.github.io/QXlsx/)";
constexpr char limereport[] = "LimeReport, version 1.6.8 (http://limereport.ru/)";
