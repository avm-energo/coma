...
public:
    ...
    static void StoreDataMem(QByteArray &mem, const QList<S2DataTypes::DataRecV> &dr, int fname);
    ...
    static bool RestoreData(QByteArray bain, QList<S2DataTypes::DataRecV> &outlist);
